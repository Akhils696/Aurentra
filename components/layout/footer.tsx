...
export function Footer() {
  ...
  const socialLinks = [
    { href: "https://www.instagram.com/aurentratechnologies", label: "Instagram", icon: InstagramIcon },
    { href: "https://linkedin.com/company/aurentra", label: "LinkedIn", icon: LinkedinIcon },
